<template>
  <thead>
    <tr>
      ...
      <th v-if="selectable" class="vgt-checkbox-col" style="height:69.9px">
        <input
          type="checkbox"
          :checked="allSelected"
        ...
        <dropdown
          ...
          @on-click="multiAction"
          :items="['Assign', 'Pickup (assign myself)','Mark Complete', 'Duplicate','Move to Project','Copy to Project','Delete']"
        ></dropdown>
        <!-- <b-dropdown size="sm"  variant="link" toggle-class="text-decoration-none" no-caret>
          <template slot="button-content">
            <b-img src="./dropdown.png" rounded="circle" alt="Action" style="width:20px"></b-img>
          </template>
          <b-dropdown-item @click="assign($event)" href="#">Assign Pickup (assign myself)</b-dropdown-item>
          <b-dropdown-item @click="markComplete($event)" href="#">Mark Complete</b-dropdown-item>
          <b-dropdown-item @click="duplicate($event)" href="#">Duplicate</b-dropdown-item>
          <b-dropdown-item @click="movetoProject($event)" href="#">Move to Project</b-dropdown-item>
          <b-dropdown-item @click="copytoProject($event)" href="#">Copy to Project</b-dropdown-item>
          <b-dropdown-item @click="deleteProject($event)" href="#">Delete</b-dropdown-item>
...
export default {
  ...
  methods: {
    ...
    multiAction(item) {
      this.$emit("multi-action-selected", item);
    }
  },
  mounted() {
