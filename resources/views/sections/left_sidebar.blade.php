<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        ...
        <ul class="nav" id="side-menu">
            ...
            <li><a href="{{ route('admin.all-tasks.protask') }}" class="waves-effect"><i class="ti-layout-list-thumb"></i> <span class="hide-menu"> @lang('app.menu.tasksPro') <span class="fa arrow"></span> </span></a>
                <ul class="nav nav-second-level">
                    <li><a href="{{ route('admin.all-tasks.protask') }}">@lang('app.menu.tasksPro')</a></li>
                </ul>
            </li>      
            @endif
