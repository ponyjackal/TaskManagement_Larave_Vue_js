...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(
        ...
        Route::group(
            ...
            Route::get('protask', ['uses' => 'ManageAllTasksController@protask'])->name('all-tasks.protask');
            
            Route::post('all-tasks/duplicate', ['uses' => 'ManageAllTasksController@duplicate'])->name('all-tasks.duplicate');
            Route::post('all-tasks/updateTask', ['uses' => 'ManageAllTasksController@updateTask'])->name('all-tasks.updateTask');
            Route::post('all-tasks/addSubtask/{id}', ['uses' => 'ManageAllTasksController@addSubtask'])->name('all-tasks.addSubtask');
            Route::post('all-tasks/exportExcel', ['uses' => 'ManageAllTasksController@exportExcel'])->name('all-tasks.exportExcel');
